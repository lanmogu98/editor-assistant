...
Provides clean console output for users with detailed file logs.
"""
...
def setup_logging(debug_mode: bool = False):
    ...
    Args:
        debug_mode: Enable debug logging to file. If None, checks
            EDITOR_ASSISTANT_DEBUG env var.
    """

    # Determine debug mode
    if debug_mode is False:
        debug_mode = os.getenv("EDITOR_ASSISTANT_DEBUG", "").lower() in (
            "1",
            "true",
            "yes",
        )
