...
SUMMARY:
[Concise summary of this paper, including publication type, authors, research question, \
methodology, key findings, conclusions, limitations, and implications]
...
FIGURES/TABLES:
- included if applicable: [Figure/Table X]: Brief description and significance

PROSPECTIVE:
- [Prospective of the paper]
