...
class LLMClient:
    ...
    def __init__(self, model_name: str):
        ...
        if not self.api_key:
            raise ValueError("API key is required. Set the VOLC_API_KEY environment variable.")
        ...
        self.pricing = config["PRICING"].get(self.model_name, {"input": 0, "output": 0})
    
    def generate_response(self, prompt: str, request_name: str = "unnamed_request") -> Dict[str, Any]:
        """
    ...
    def save_token_usage_report(self, project_name: str, output_dir: Path) -> None:
        ...
        with open(token_dir / "token_usage.txt", 'w', encoding='utf-8') as f:
            ...
            f.write(f"  Total Process Time: {token_usage['process_times']['total_time']:.2f} seconds\n")
