...
class TestOutlineTaskIntegration:
    ...
    async def test_outline_generates_structured_output(
        ...
        success, run_id = await processor.process_mds(
            [paper_article], ProcessType.OUTLINE, output_to_console=False
        )
...
class TestMultiSourceIntegration:
    ...
    @pytest.mark.integration
    @pytest.mark.slow
    async def test_brief_with_multiple_sources(
        self, processor, multiple_articles, temp_dir
    ):
...
class TestStreamingIntegration:
    ...
    @pytest.mark.integration
    @pytest.mark.slow
    async def test_streaming_produces_output(
        self, streaming_processor, test_article, temp_dir, capsys
    ):
        """
    ...
    @pytest.mark.integration
    @pytest.mark.slow
    async def test_non_streaming_produces_output(
        self, non_streaming_processor, test_article, temp_dir
    ):
        """
