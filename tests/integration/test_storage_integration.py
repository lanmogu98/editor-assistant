...
def _run_cli(
    args: List[str], *, timeout: int, env: Optional[Dict[str, str]] = None
...
class TestStorageIntegration:
    ...
    @pytest.mark.slow
    async def test_real_run_recorded_in_database(
        ...
        success, run_id = await processor.process_mds(
            [sample_article], ProcessType.BRIEF, output_to_console=False
        )
